...
from app.services.idempotency import IdempotencyInFlight, check_or_register, record_response
...
async def submit_order(
    ...
    *,
    ...
    # 事务2：update order 状态 + submitted_at + record_response 回写幂等 first_response
